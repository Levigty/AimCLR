...
if __name__ == '__main__':
    ...
    parser.add_argument('--dataset_path', default='E:/2021/datasets/crossclr_pkummd/pku_part1')
    parser.add_argument('--out_folder', default='E:/2021/datasets/crossclr_pkummd/pku_part1_frame50')
